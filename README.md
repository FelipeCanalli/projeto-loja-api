<p float="left">
  ...
  <img style="padding-bottom:2%" src="./img/reactnative.gif" width=8%" /> 
</p>

| Diretório | Descrição |
| ------ | ------ |
|  [/appvenda](https://github.com/FelipeGalvao1/app-loja-react-native)|Dentro desse submodule está o versionamento do aplicativo usando React Native ; Você pode ver ele clicando [aqui](https://github.com/FelipeGalvao1/app-loja-react-native)     |

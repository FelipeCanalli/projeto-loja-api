...
!empty($data->nomecli) && !empty($data->cpf) && !empty($data->sexo) && 
!empty($data->email) && !empty($data->telefone) && !empty($data->tipo) && 
!empty($data->logradouro) && !empty($data->numero) && !empty($data->complemento) && 
!empty($data->bairro) && !empty($data->cep)){
    
    $cadastro->nomecli=$data->nomecli;

...
// o método POST, vamos postar o idcli
...
// Vamos fazer uma instância da classe HistoricoPedido para ter acesso a todo 
// o seu conteúdo.
...
*/
    ...
    array_push($hp_arry["saida"],$array_item);
    }

    header("HTTP/1.0 200");
    echo json_encode($hp_arry);
}else{
    header("HTTP/1.0 400");
